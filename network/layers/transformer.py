...
class Positional_encoding(nn.Module):
    def _init__(self, PE_size, n_position=256):
...
class TransformerLayer(nn.Module):
    def __init__(self, out_dim, in_dim, num_heads, attention_size,
        ...
        for i in range(self.block_nums):
            ...
            ##TODO: warnning that `attention_size` == `out_dim`
...
class Transformer(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, num_heads=8,
        ...
        ##TODO: Dynamic optional parameters for `Positional_encoding` layer
    ...
    def forward(self, x, adj):
        ...
        ##TODO: dynamic param for `cat` or `add`
        # x = x1 + self.conv1(x)

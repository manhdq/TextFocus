...
class GridGenerator():
    ...
    def __init__(self, cfg):
        self.max_valid_size = cfg.max_valid_size
        self.grid_threshold = cfg.grid_threshold
        self.overlap_ratio = cfg.overlap_ratio
        self.base_scale_down = cfg.base_scale_down
        self.valid_range = cfg.valid_range
        self.interpolation = cfg.interpolation
        self.max_chip_size = cfg.max_chip_size
                ...
                scaled_down_tiles = [
                    {
                        ...
                        "prev_left_shift": 0,
                        "prev_top_shift": 0,
                        "prev_right_shift": self.image_width - new_width,
                        "prev_bottom_shift": 0,
                    },
                    {
                        "image": tile_2,
                ...
                scaled_down_tiles = [
                    {
                        ...
                        'prev_top_shift': 0,
                        "prev_right_shift": 0,
                        "prev_bottom_shift": self.image_height - new_height,

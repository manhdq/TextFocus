...
ctw_root_dir = '/home/ubuntu/Documents/working/pixtaVN/RA/TextBPN++/data/CTW1500/yolo/'
ctw_train_data_dir = ctw_root_dir + 'Images/train/'
ctw_test_data_dir = ctw_root_dir + 'Images/test/'
ctw_train_gt_dir = ctw_root_dir + 'gt/train/'
ctw_test_gt_dir = ctw_root_dir + 'gt/test/'
...
class PAN_CTW_China(data.Dataset):
    def __init__(self,
                 split='train',
                 is_transform=False,
                 img_size=None,
